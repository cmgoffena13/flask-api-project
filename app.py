...
def create_app(db_url=None):   
    ...
    app.config['JWT_SECRET_KEY'] = "56451425226553273229737271541255572750" #secrets.SystemRandom().getrandbits(128)
    jwt = JWTManager(app)
    ...
    def invalid_token_callback(error):
        return (jsonify(
            {"message": "Signature verification failed.", "error": "invalid_toke"}, 401
        ))
